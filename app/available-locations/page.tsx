    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mb-12 grid gap-6 sm:grid-cols-3">
        <div className="rounded-lg border border-gray-200 bg-white p-6 text-center dark:border-gray-700 dark:bg-gray-900">
          <p className="text-primary-600 dark:text-primary-400 mb-2 text-4xl font-bold">
            {stateEntries.length}+
          </p>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 text-center dark:border-gray-700 dark:bg-gray-900">
          <p className="text-primary-600 dark:text-primary-400 mb-2 text-4xl font-bold">
            {Object.values(cities).reduce((acc, cityObj) => acc + Object.keys(cityObj).length, 0)}+
          </p>
          <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Cities Served</p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-white p-6 text-center dark:border-gray-700 dark:bg-gray-900">
          <p className="text-primary-600 dark:text-primary-400 mb-2 text-4xl font-bold">50 kg</p>
      ...
      <div className="space-y-8">
        {stateEntries.map(([state, cityData]) => {
            ...
            >
              ...
              <div className="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                  {cityNames.length} {cityNames.length === 1 ? 'city' : 'cities'} available
                </p>
              </div>
                ...
                {sortedCities.map((city) => {
                  ...
                  return (
                    <Link
                      key={city}
                      href={cityUrl}
                      className="group hover:border-primary-500 hover:bg-primary-50 dark:hover:border-primary-400 flex items-center justify-between rounded-md border border-gray-200 bg-gray-50 px-4 py-3 transition-all dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                    >
      ...
      {/* CTA Section */}
      <div className="from-primary-50 to-primary-100 mt-12 rounded-lg border border-gray-200 bg-gradient-to-br p-8 text-center dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
      ...
      {/* SEO Content */}
      <div className="prose prose-lg dark:prose-invert mt-12">
        ...
        <p>
          Our delivery network covers all major metro cities and tier-2 commercial centers, ensuring
          reliable supply chains for your business. Every order comes with proper GST invoicing,
          quality assurance, and flexible payment terms for established buyers.
        </p>
