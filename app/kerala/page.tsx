...
// Static metadata for Kerala
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Kerala | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Kerala. We deliver premium wholesale chai to hotels, offices, and retailers across Kerala. Check our delivery locations.`,
  canonical: '/kerala',
})

// Cities in Kerala
const citiesInState = ['Kochi', 'Thiruvananthapuram', 'Kozhikode', 'Kollam']
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Kerala</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Kerala
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across <strong>Kerala</strong>.
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Kerala
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Kerala is designed to meet the high-volume demands of
                wholesalers, semi-wholesalers, and institutional buyers. Moisture-safe packaging is
                important for Kerala supply.
              </p>
              <p>
