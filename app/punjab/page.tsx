...
// Static metadata for Punjab
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Punjab | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Punjab. We deliver premium wholesale chai to hotels, offices, and retailers across Punjab. Check our delivery locations.`,
  canonical: '/punjab',
})

// Cities in Punjab
const citiesInState = ['Ludhiana', 'Jalandhar', 'Amritsar']
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Punjab</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Punjab
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across <strong>Punjab</strong>.
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Punjab
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Punjab is designed to meet the high-volume demands of
                wholesalers, semi-wholesalers, and institutional buyers. Ludhiana is a major
                industrial supply point.
              </p>
              <p>
