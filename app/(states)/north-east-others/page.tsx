...
// Static metadata for North-East-Others
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in North-East-Others | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in North-East-Others. We deliver premium wholesale chai to hotels, offices, and retailers across North-East-Others. Check our delivery locations.`,
  canonical: '/north-east-others',
})

// Cities in North-East-Others
const citiesInState = ['Agartala', 'Itanagar', 'Imphal']

export default function NorthEastOthersPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'North-East-Others', item: '/north-east-others' },
  ])
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">North-East-Others</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in North-East-Others
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>North-East-Others</strong>. We serve {cityCount} major cities in the region,
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in North-East-Others
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in North-East-Others is designed to meet the high-volume
                demands of wholesalers, semi-wholesalers, and institutional buyers. Supply routes
                extend from Assam.
              </p>
              <p>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Available Cities in North-East-Others
            </h2>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {citiesInState.map((city) => {
                ...
                return (
                  <Link
                    key={city}
                    href={`/north-east-others/${citySlug}`}
          ...
          <section className="rounded-xl bg-green-50 p-6 dark:bg-green-900/10">
            <h3 className="mb-2 text-xl font-semibold text-green-800 dark:text-green-400">
              Partner with Us in North-East-Others
            </h3>
