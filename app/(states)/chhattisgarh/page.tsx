...
// Static metadata for Chhattisgarh
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Chhattisgarh | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Chhattisgarh. We deliver premium wholesale chai to hotels, offices, and retailers across Chhattisgarh. Check our delivery locations.`,
  canonical: '/chhattisgarh',
})

// Cities in Chhattisgarh
const citiesInState = ['Raipur', 'Bhilai']
...
export default function ChhattisgarhPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Chhattisgarh', item: '/chhattisgarh' },
  ])
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Chhattisgarh</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Chhattisgarh
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>Chhattisgarh</strong>. We serve {cityCount} major cities in the region, providing
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Chhattisgarh
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Chhattisgarh is designed to meet the high-volume demands
                of wholesalers, semi-wholesalers, and institutional buyers. Raipur is a central
                state distribution hub.
              </p>
              <p>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Available Cities in Chhattisgarh
            </h2>
          ...
          <section className="rounded-xl bg-green-50 p-6 dark:bg-green-900/10">
            <h3 className="mb-2 text-xl font-semibold text-green-800 dark:text-green-400">
              Partner with Us in Chhattisgarh
            </h3>
