...
// Static metadata for Tamil Nadu
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Tamil Nadu | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Tamil Nadu. We deliver premium wholesale chai to hotels, offices, and retailers across Tamil Nadu. Check our delivery locations.`,
...
export default function TamilNaduPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Tamil Nadu', item: '/tamil-nadu' },
  ])
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Tamil Nadu</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Tamil Nadu
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>Tamil Nadu</strong>. We serve {cityCount} major cities in the region, providing
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Tamil Nadu
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Tamil Nadu is designed to meet the high-volume demands
                of wholesalers, semi-wholesalers, and institutional buyers. Chennai acts as a major
                southern logistics gateway for bulk tea.
              </p>
              <p>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Available Cities in Tamil Nadu
            </h2>
