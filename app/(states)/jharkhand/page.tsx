...
// Static metadata for Jharkhand
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Jharkhand | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Jharkhand. We deliver premium wholesale chai to hotels, offices, and retailers across Jharkhand. Check our delivery locations.`,
  canonical: '/jharkhand',
})

// Cities in Jharkhand
const citiesInState = ['Ranchi', 'Jamshedpur', 'Dhanbad']
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Jharkhand</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Jharkhand
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>Jharkhand</strong>. We serve {cityCount} major cities in the region, providing
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Jharkhand
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Jharkhand is designed to meet the high-volume demands of
                wholesalers, semi-wholesalers, and institutional buyers. Ranchi is supplied via
                eastern freight routes.
              </p>
              <p>
