...
// Static metadata for Odisha
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Odisha | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Odisha. We deliver premium wholesale chai to hotels, offices, and retailers across Odisha. Check our delivery locations.`,
  canonical: '/odisha',
})

// Cities in Odisha
const citiesInState = ['Bhubaneswar', 'Cuttack', 'Rourkela']
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Odisha</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Odisha
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across <strong>Odisha</strong>.
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Odisha
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Odisha is designed to meet the high-volume demands of
                wholesalers, semi-wholesalers, and institutional buyers. Bhubaneswar is a state
                logistics centre.
              </p>
              <p>
