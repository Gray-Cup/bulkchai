...
// Static metadata for Madhya Pradesh
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Madhya Pradesh | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Madhya Pradesh. We deliver premium wholesale chai to hotels, offices, and retailers across Madhya Pradesh. Check our delivery locations.`,
  canonical: '/madhya-pradesh',
})

// Cities in Madhya Pradesh
const citiesInState = ['Indore', 'Bhopal', 'Jabalpur', 'Gwalior', 'Ujjain']
...
export default function MadhyaPradeshPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Madhya Pradesh', item: '/madhya-pradesh' },
  ])
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Madhya Pradesh</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Madhya Pradesh
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>Madhya Pradesh</strong>. We serve {cityCount} major cities in the region,
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Madhya Pradesh
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Madhya Pradesh is designed to meet the high-volume
                demands of wholesalers, semi-wholesalers, and institutional buyers. Indore is a
                central MP logistics hub.
              </p>
              <p>
          ...
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Available Cities in Madhya Pradesh
            </h2>
          ...
          <section className="rounded-xl bg-green-50 p-6 dark:bg-green-900/10">
            <h3 className="mb-2 text-xl font-semibold text-green-800 dark:text-green-400">
              Partner with Us in Madhya Pradesh
            </h3>
