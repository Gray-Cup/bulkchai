...
// Static metadata for Uttar Pradesh
export const metadata: Metadata = generatePageMetadata({
  title: `Bulk Tea Supplier in Uttar Pradesh | Wholesale Chai | BulkCTC`,
  description: `Leading bulk CTC tea supplier in Uttar Pradesh. We deliver premium wholesale chai to hotels, offices, and retailers across Uttar Pradesh. Check our delivery locations.`,
  canonical: '/uttar-pradesh',
})

// Cities in Uttar Pradesh
const citiesInState = ['Lucknow', 'Kanpur', 'Agra', 'Varanasi', 'Ghaziabad', 'Meerut']
...
export default function UttarPradeshPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Uttar Pradesh', item: '/uttar-pradesh' },
  ])
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="font-medium text-gray-900 dark:text-gray-100">Uttar Pradesh</li>
        </ol>
      </nav>

      <div className="mb-12">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-100">
          Bulk Tea Supply in Uttar Pradesh
        </h1>
        <p className="max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Gray Cup Enterprises is a premier supplier of bulk CTC tea across{' '}
          <strong>Uttar Pradesh</strong>. We serve {cityCount} major cities in the region, providing
        ...
        <div className="md:col-span-2">
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-gray-900 dark:text-gray-100">
              Supply Network in Uttar Pradesh
            </h2>
            <div className="prose dark:prose-invert">
              <p>
                Our distribution network in Uttar Pradesh is designed to meet the high-volume
                demands of wholesalers, semi-wholesalers, and institutional buyers. Lucknow is
                supplied through central Uttar Pradesh freight corridors.
              </p>
              <p>
          ...
          <section className="rounded-xl bg-green-50 p-6 dark:bg-green-900/10">
            <h3 className="mb-2 text-xl font-semibold text-green-800 dark:text-green-400">
              Partner with Us in Uttar Pradesh
            </h3>
