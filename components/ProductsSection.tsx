  ...
  return (
    <section className="mt-16 border-t border-gray-200 pt-12 dark:border-gray-700">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href="/cart"
          className="flex items-center gap-1.5 border border-gray-200 px-3 py-1.5 text-sm font-medium text-neutral-600 transition-colors hover:border-gray-400 dark:border-gray-700 dark:text-neutral-400"
        >
          <svg
            className="h-4 w-4"
            fill="none"
